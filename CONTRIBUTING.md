...
To get ready to work on the codebase, please make sure to have [NodeJS](https://nodejs.org/en/) & [pnpm](https://pnpm.io/installation) installed.  Then, run the following command to install the dependencies:
