...
| `frankframework.startupProbe.exec.command`          | Command for livenessProbe                                                                                                   | `["curl","-f","http://127.0.0.1:8080/iaf-test/iaf/api/server/health"]` |
...
| `frankframework.livenessProbe.exec.command`         | Command for livenessProbe                                                                                                   | `["curl","-f","http://127.0.0.1:8080/iaf-test/iaf/api/server/health"]` |
...
| `frankframework.readinessProbe.exec.command`        | Command for livenessProbe                                                                                                   | `["curl","-f","http://127.0.0.1:8080/iaf-test/iaf/api/server/health"]` |
